...
subtitle: "Candidate retrieval in large-scale recommendation systems"
author: hoangbm
tags: [nlp, recsys]
social-share: true
---
...
Giving an item, *retrieval* helps you to find a similar item to that by calculating the distances between the given item and every other items in the item space. To do this, the most important task is to find an appropriate metrics which helps you to compute the similarity between things.

<p align="center">
 <img src="/images/retrieval/retrieval.png" alt="" align="middle">
 <div align="center"> Retrieval</div>
</p>

On the other hand, clustering helps you to group the similar items in the space. Items with similar characteristics will be near each other and then we assume that they are in the same cluster. Obviously, every problem which is related to similarity is in need of a distance metrics. Each cluster will be represented by its centroid, which is in most cases the average point of the items in that cluster.

<p align="center">
 <img src="/images/retrieval/clustering.png" alt="" align="middle">
...
* Bag of Word (BoW): It is quite similar to the histogram in the visual domain. We count the occurrence of each word in the corpus, then make the vector with that. There is a major drawback with this idea: There are some words which appear in almost every document like *a, the, you, etc.*
...
$$a_1, .., a_d$$ are the weights for each feature. This feature selection is in fact not very popular in reality since feature engineering is always hard for us. So the non-scaled version is more preferable:
...
<p align="center">
 <img src="/images/retrieval/tree-construction.png" alt="" align="middle">
...
<p align="center">
 <img src="/images/retrieval/step1.png" alt="" align="middle">
...
<p align="center">
 <img src="/images/retrieval/step2.png" alt="" align="middle">
 <div align="center"> Compute the temporary nearest distance</div>
</p>

* Step 3: Backtrack using traversal technique and try other branches. If the distance from the query point to the branch is shorter than the current nearest distance, we examine this branch to compute the (maybe) next nearest distance. If not, we just ignore the branch and move the next one.

<p align="center">
 <img src="/images/retrieval/step3.png" alt="" align="middle">
...
<p align="center">
 <img src="/images/retrieval/cons.png" alt="" align="middle">
...
<p align="center">
 <img src="/images/retrieval/random-bin.png" alt="" align="middle">
...
<p align="center">
 <img src="/images/retrieval/more-bin.png" alt="" align="middle">
